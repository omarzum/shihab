...
## [3.0.0](https://github.com/omarzum/shihab/compare/v2.39.0...v3.0.0) (2025-12-29)
...
* 🏎️💨 ([3850b04](https://github.com/omarzum/shihab/commit/3850b044a9e5ec7d4f124bf7425fe18c667e427d))
* 🏎️💨 ([833a7ae](https://github.com/omarzum/shihab/commit/833a7aea3333497555d31824a15fdd632b0e5f52))
* 4300% performance improvement ([4a91bb7](https://github.com/omarzum/shihab/commit/4a91bb7fc7736f1de03706cf8381b2d0a209bfa4))
* add API response to IMDB metadata retrieval error logs ([242e83a](https://github.com/omarzum/shihab/commit/242e83a7e1bad5303fa6dfa8298d2fd9c2ec4f22))
* add catalog and magnet resolve timeouts to configuration ([eb3b5e8](https://github.com/omarzum/shihab/commit/eb3b5e87c76729ba15c9110dd068256f3f57bbf6))
* add ChillLink API endpoints and refactor stream description formatting logic ([ec2aa2b](https://github.com/omarzum/shihab/commit/ec2aa2bb170b4bef70dee0ce452f94ab53d44f94))
* add ChillLink Protocol support to README ([8d8c484](https://github.com/omarzum/shihab/commit/8d8c4844cfe24c874260e665945af1a2ffde88da))
* add comet scraper ([a11a65e](https://github.com/omarzum/shihab/commit/a11a65e37fd1a37cd119df7e17f4d8fcf93a6ab7))
* add database indexes for performance optimization across multiple tables ([c806078](https://github.com/omarzum/shihab/commit/c80607871ee9c0101bdb5a4757eaeb2cc3d10087))
* add DEBRID_CACHE_CHECK_RATIO setting and update availability ch… ([0173711](https://github.com/omarzum/shihab/commit/0173711eeda1dd0cfe121e6b153c124ded8b31b9))
* add DEBRID_CACHE_CHECK_RATIO setting and update availability check logic ([3ecd35a](https://github.com/omarzum/shihab/commit/3ecd35aa9fcfa12de7910a7fc05c4fae05e231f6))
* add default PostgreSQL service to Docker Compose, configure Comet to use it, and introduce SQLite concurrency warnings ([24fb50b](https://github.com/omarzum/shihab/commit/24fb50bf77645dfbcf103df78e6e8f51d4855511))
* add handling for empty torrent lists in filter_manager ([aef2549](https://github.com/omarzum/shihab/commit/aef2549f3697707a433a4ff459703a27aa1623b4))
* add live torrent cache TTL and update related settings ([6e2e420](https://github.com/omarzum/shihab/commit/6e2e420d7379824d9b76ca603703f914349cf20b))
* add logging for scraper activity in TorrentManager ([6324112](https://github.com/omarzum/shihab/commit/63241126a2980f54230412e4a63e904b9e0804a5))
* add MediaFusion API password support ([f15bbf1](https://github.com/omarzum/shihab/commit/f15bbf1d54682edfa8e915ab31c526e2e6c6725b))
* add MediaFusion live search configuration ([f843929](https://github.com/omarzum/shihab/commit/f8439296f517de8ac2a4de6e0d0c2580213c4a57))
* add metrics caching functionality and update settings for metrics cache TTL ([e3c269b](https://github.com/omarzum/shihab/commit/e3c269ba050be48a834bbf9cbe0609415362cee7))
* add metrics to dashboard ([37f3e86](https://github.com/omarzum/shihab/commit/37f3e8664221e0f176817836e6e76c6cc284a5aa))
* Add NO_CACHE_HEADERS and update FileResponse usage in streaming ([52dce02](https://github.com/omarzum/shihab/commit/52dce02b98417139b2afd775e5c23b8f51eb6f0a))
* add OpenAPI tags, summaries, and descriptions to API endpoints and parameters ([da1d5a7](https://github.com/omarzum/shihab/commit/da1d5a7fbd6feb9e0e2c9a57d9456fae5744bddb))
* add robust error handling to the Prowlarr scraper ([95866a6](https://github.com/omarzum/shihab/commit/95866a68abe0bf4e38c6eab0f6f6576ebbcd37e6))
* Add StremThru scraper ([13da997](https://github.com/omarzum/shihab/commit/13da997bb2bbf68949c3f55fcc363605614c218c))
* add support for Debrider debrid service ([e16f817](https://github.com/omarzum/shihab/commit/e16f817a99bd9a23066a97a8b5768540b750c261))
* add timeouts to Prowlarr API requests ([c0d7060](https://github.com/omarzum/shihab/commit/c0d70607b28164f6e29ca7481bf17ea0fa126b64))
* add YGGTorrent scraper ([4a677bf](https://github.com/omarzum/shihab/commit/4a677bf773f6e6351aee698b137b467bb23473ae))
* add YGGTorrent scraper ([2317e88](https://github.com/omarzum/shihab/commit/2317e884e215c4f6367d05b19d77e1971fccf612))
* add YGGTORRENT_PASSKEY setting and update Yggtorrent scraper to parse info hash from page HTML and use passkey for tracker sources ([c442b0c](https://github.com/omarzum/shihab/commit/c442b0c2691c2022e5da244010e9ae20621faaf2))
* add YGGTORRENT_PASSKEY setting and update Yggtorrent scraper to parse info hash from page HTML and use passkey for tracker sources ([6e44eb2](https://github.com/omarzum/shihab/commit/6e44eb260dcf4354308b9e7c36f61c3c55593f38))
* AIOStreams scraper ([f77a720](https://github.com/omarzum/shihab/commit/f77a7207139df6324f576ed3c77c010621f4ceba))
* AIOStreams scraper ([cc43614](https://github.com/omarzum/shihab/commit/cc436148b4f5f29d7ed8eeffdf4174671db4de84))
* allow_english_in_languages in webui ([886ec29](https://github.com/omarzum/shihab/commit/886ec29dedcde8895c424a5297cc98f4e3ab116c))
* and now we can stream ([dbf2f4e](https://github.com/omarzum/shihab/commit/dbf2f4e26f13481d6e74501f271b6e9843ecea9c))
* availability cache logic finished ([a2f1ac1](https://github.com/omarzum/shihab/commit/a2f1ac14b8477ce1a9594575dd5e3358d3541a0d))
* background scraper ([7127a8e](https://github.com/omarzum/shihab/commit/7127a8ebe144ac6bcff44afb0d307639a51cfdef))
* background scraper ([ed52431](https://github.com/omarzum/shihab/commit/ed5243143c60eaa5bdab434c659ebe49e6f077bf))
* bandwidth monitoring ([5f7c033](https://github.com/omarzum/shihab/commit/5f7c03306906cabc71f1c523430868cb15443b97))
* better cache ttl ([9dacb30](https://github.com/omarzum/shihab/commit/9dacb309bcd50a6111e983c4311ece709e0a3909))
* better db - everything ([7f02c5e](https://github.com/omarzum/shihab/commit/7f02c5ee511cbacaf37945242a3c5b8ffc1279e7))
* better everything ([fa1ce1a](https://github.com/omarzum/shihab/commit/fa1ce1ae0f179511888298d030dcb8ca7e1bdee1))
* better file choice when playback ([b17c7c9](https://github.com/omarzum/shihab/commit/b17c7c905e39a7d5df2981aa9f26b1d549f55068))
* better file choosing logic ([ad13278](https://github.com/omarzum/shihab/commit/ad132781df58bf6eefef8c4bbe4ad32f7f874519))
* better kitsu ([f0d997e](https://github.com/omarzum/shihab/commit/f0d997e137942c74b001a6ba34511a515bb1268e))
* better kitsu aliases ([b676895](https://github.com/omarzum/shihab/commit/b676895da758bd3ab512d26d949e2a1283f8e409))
* better logging ([19a7e9e](https://github.com/omarzum/shihab/commit/19a7e9ef9526717226a029a4e0e9bc757602fbde))
* bitmagnet scraper ([26e3e5e](https://github.com/omarzum/shihab/commit/26e3e5eb757c515c6335ad72cdb4547d833b46d7))
* bitmagnet scraper ([3619fe5](https://github.com/omarzum/shihab/commit/3619fe50849cab54f84070e7e79a78926d9fa03f))
* cached only mode ([82417ea](https://github.com/omarzum/shihab/commit/82417ea9ba8a6a73e31b922b6fdb06f2d6928142))
* cached results on top ([857d3b7](https://github.com/omarzum/shihab/commit/857d3b76b1cf4c711be2e22037d1fc600aff9e3a))
* caching operations now in background ([2726a50](https://github.com/omarzum/shihab/commit/2726a507548fe59413fc7a187aa30ae1967dff22))
* ChillLink Support ([b066b54](https://github.com/omarzum/shihab/commit/b066b5495a86191bd08d366f8f198dc190a54974))
* choose max size file if no file found ([3ed5057](https://github.com/omarzum/shihab/commit/3ed5057b0856ba95ab823a66ae0fdc64882c16bb))
* code cleaning ([cfe7126](https://github.com/omarzum/shihab/commit/cfe7126524f2690ef38eb329e2591f7ca2ef2918))
* custom rtn settings ([c640068](https://github.com/omarzum/shihab/commit/c640068975b831e516e25db075a6c521a36e8744))
* dashboard endpoint to see proxy active connections ([6c14253](https://github.com/omarzum/shihab/commit/6c14253ee7fbc5f23e9110a15217cdb95cf038d7))
* database migration system ([29a27ad](https://github.com/omarzum/shihab/commit/29a27adc2894c44046e144d0e11c8cba6532e782))
* **debrid/stremthru:** forward client ip ([982c398](https://github.com/omarzum/shihab/commit/982c398774480badbb60d7214a91c3a62260fee6))
* **debrid/stremthru:** match behavior with mediafusion ([24611a2](https://github.com/omarzum/shihab/commit/24611a2940dec82cd3cd09aab757cef06a9beb8a))
* **debrid/stremthru:** pass stremio video id for magnet cache check ([786a298](https://github.com/omarzum/shihab/commit/786a2985ca3ef2463b65c684bc8cef6a86ce772f))
* **debrid/stremthru:** use default url only for specific services ([f0b029d](https://github.com/omarzum/shihab/commit/f0b029d7933bc85a7ca794c3edea1afccc8d4f28))
* **debrid:** add support for stremthru ([778a59e](https://github.com/omarzum/shihab/commit/778a59e2300763cb8c418d5f4771742f450f427a))
* **debrid:** add support for stremthru ([64ba2b3](https://github.com/omarzum/shihab/commit/64ba2b39fb0faab69e16e8755f024eb82c14f888))
* debridio scraper ([feaca56](https://github.com/omarzum/shihab/commit/feaca56b36b0f8215c7a000261433aaf6d48fcbb))
* debridio scraper ([95c3879](https://github.com/omarzum/shihab/commit/95c3879f34c23e7fdb4bcfee94326cb31aedea21))
* decouple Jackett and Prowlarr scraper configurations from a generic indexer manager ([d17cb2d](https://github.com/omarzum/shihab/commit/d17cb2d7b3b1c3d72f7b2df92a47f853d71a89fd))
* decouple Jackett and Prowlarr scraper configurations from a generic indexer manager ([460fad2](https://github.com/omarzum/shihab/commit/460fad22b48ddcf465fd4f126a244bb1295bec1d))
* dev to main ([2d2ded3](https://github.com/omarzum/shihab/commit/2d2ded3f6a70b7efce0d134d281809cd8a5f7015))
* different modes for scrapers (live/background/both) ([b27e6ad](https://github.com/omarzum/shihab/commit/b27e6adebaa4a311aa6a9144595bd94259cb9bfc))
* different modes for scrapers (live/background/both) ([278a130](https://github.com/omarzum/shihab/commit/278a130d009d07cfadd363b6e9c4e125ee30279f))
* docker images for rewrite branch too yeee ([0d89333](https://github.com/omarzum/shihab/commit/0d893338aa76426ffa9d871182e5d4107aaca8b4))
* enhance admin dashboard with dynamic tracker limit selection and optimize database metrics query ([5df4121](https://github.com/omarzum/shihab/commit/5df412125bbd668661473a5512f1f9c0b22d6b93))
* enhance Nyaa scraper with anime-only option and integrate anime mapping functionality ([f9c361c](https://github.com/omarzum/shihab/commit/f9c361cc7d05f39911822b2b2780d86613ca74d7))
* enhance Nyaa scraper with anime-only option and integrate anime… ([a424f81](https://github.com/omarzum/shihab/commit/a424f8181a418a04c28434e8258be53bf759cbda))
* enhance Nyaa scraper with Kitsu-only option ([1b5b734](https://github.com/omarzum/shihab/commit/1b5b7344c426b08521de4074f7d297b6a12377a5))
* enhance playback functionality with media_id and aliases support ([eb9cbdc](https://github.com/omarzum/shihab/commit/eb9cbdc680a491575457af6f8c8ac198533f8895))
* enhance result formatting ([afc8d6f](https://github.com/omarzum/shihab/commit/afc8d6f3b177538d1044b244a8c749e5060476fc))
* Enhance URL encoding by using `safe=''` in `quote` calls for playback and magnet URIs ([5664a86](https://github.com/omarzum/shihab/commit/5664a86eeb9a991796ff0d60e3c79f8bdbb5532d))
* Enhance URL encoding by using `safe=''` in `quote` calls for playback and magnet URIs ([96a962f](https://github.com/omarzum/shihab/commit/96a962faac555390bb9c461e345542324bdeb372))
* fetch indexer statuses from response ([bd51abf](https://github.com/omarzum/shihab/commit/bd51abf40e9173fe3a366cfa9b5bcc0f91d77767))
* fix Debridio scraper ([85c0aee](https://github.com/omarzum/shihab/commit/85c0aee7dcf7c3a641bfaa079c4c7b5428e298bf))
* fix Debridio scraper ([3f93e1e](https://github.com/omarzum/shihab/commit/3f93e1e783a6b491c5d3837b08eae4fded1cc396))
* fix imdb_id: in media_id ([607b5b3](https://github.com/omarzum/shihab/commit/607b5b38a39b412d73f0e021048735de8dbf4d3f))
* fix sqlite journal_mode ([f052167](https://github.com/omarzum/shihab/commit/f052167a41fb137c93b10a5843b2ec02897f26fe))
* FORCE_STREMTHRU ([52f1a45](https://github.com/omarzum/shihab/commit/52f1a4502c21dd1a0a3edfcf1443f67c0e374b5d))
* full direct torrent support ([013e294](https://github.com/omarzum/shihab/commit/013e294b804fc8b515ad7c0e50865e685e1e8453))
* get file index from debrid services ([8308ba8](https://github.com/omarzum/shihab/commit/8308ba8870a5ad0abc0aad29a9f74722f5b2cdab))
* guvicorn + gevent ([c514cbb](https://github.com/omarzum/shihab/commit/c514cbb0e16ec1942386437bbf20c4c1e3b7c38f))
* guvicorn support ([6304079](https://github.com/omarzum/shihab/commit/63040796009895ed30d5f3e17644ad4091b29d36))
* haha ([ea91c9e](https://github.com/omarzum/shihab/commit/ea91c9e7c9cebed630da4743767a5b38f185fbbe))
* hide debrid stream proxy password input if disabled ([7074893](https://github.com/omarzum/shihab/commit/70748933e26f275e350d93fe15f39fa6c0861de0))
* Implement associate_mediafusion_urls_passwords function and upd… ([37d080f](https://github.com/omarzum/shihab/commit/37d080fea7ea815b7d66053104b1df8c6a56248d))
* Implement associate_mediafusion_urls_passwords function and update mediafusion URL handling in main and manager modules ([de638d1](https://github.com/omarzum/shihab/commit/de638d1f38893db3314d7f879d7edc47b9aec8a2))
* Implement database import/export CLI tool ([52efbf1](https://github.com/omarzum/shihab/commit/52efbf176941b92b9497eeaa33c0b90e1dc49f00))
* Implement database import/export CLI tool ([07a0885](https://github.com/omarzum/shihab/commit/07a0885e6928b72707980cacc13f200aec7ec1c0))
* implement dynamic Prowlarr indexer management with initialization wait, update Jackett management, and add related settings and logging ([1152b42](https://github.com/omarzum/shihab/commit/1152b42c2ee072f73607bb9480f83e0993751c1c))
* Implement multi-instance scraping support for Comet, Zilean, Torrentio, and MediaFusion ([c0eeb0d](https://github.com/omarzum/shihab/commit/c0eeb0da6e0c0866e813176fba181659c64626eb))
* Implement multi-instance scraping support for Comet, Zilean, Torrentio, and MediaFusion ([30b6cf3](https://github.com/omarzum/shihab/commit/30b6cf3c005a7a086ba2c43f66a702d0180faf43))
* implement new admin dashboard ([dfe00a2](https://github.com/omarzum/shihab/commit/dfe00a280c37686df9cc0ad5a1bc9e0d32fcc125))
* improved file index update logic ([f5c4524](https://github.com/omarzum/shihab/commit/f5c45244355c33abaf5ac82732f7f639f7c6b4c2))
* improved logger ([58f6b44](https://github.com/omarzum/shihab/commit/58f6b44a4a30ae2bdac8924fc7ffdd50a74a4272))
* improved torrent file index finder logic ([f05e03c](https://github.com/omarzum/shihab/commit/f05e03c95a74d7559f54f69bce68e118c88df89d))
* init readme for rewrite ([322c063](https://github.com/omarzum/shihab/commit/322c063e002ab0149d11d4d3b2362bb1f323df3e))
* introduce a Python script for Comet instance uptime monitoring and Discord notifications ([b61f196](https://github.com/omarzum/shihab/commit/b61f196d0b868ea53759363ef3452f622450a8b3))
* introduce IndexerManager service to dynamically update and manage Jackett and Prowlarr indexers ([beacb2a](https://github.com/omarzum/shihab/commit/beacb2a966fc8969aa3070cbc9e0511073d55b6d))
* introduce IndexerManager service to dynamically update and manage Jackett and Prowlarr indexers ([8265cc5](https://github.com/omarzum/shihab/commit/8265cc55aae8b796e18ee8b738e38d98b9a9990c))
* ios video players support (ex: infuse) ([acc8112](https://github.com/omarzum/shihab/commit/acc8112a2a5966ac62b2b2c54105425680b98ccf))
* ip limit for stream proxy ([dab5166](https://github.com/omarzum/shihab/commit/dab5166f764aaeee34240c96d3982b9d68397904))
* jackettio scraper ([b24b545](https://github.com/omarzum/shihab/commit/b24b5451d1514b3449124598d23cd0f94ac17d49))
* jackettio scraper ([31b010d](https://github.com/omarzum/shihab/commit/31b010dbe9cc0ee74b3378ecb9eed705c2ce40ce))
* lock system for comet clusters ([dd2171b](https://github.com/omarzum/shihab/commit/dd2171bdcda8e3b7a4551882e23c6a7a15fcc218))
* maybe release soon ([be3850f](https://github.com/omarzum/shihab/commit/be3850f634d4ec32aedf5e9514c7193020a9eff6))
* mediafusion live search is not enabled by default?? ([91c13df](https://github.com/omarzum/shihab/commit/91c13df7d4dbbd780053aa1396aab3b45425c6b3))
* more info ([5e6c265](https://github.com/omarzum/shihab/commit/5e6c2656d3a4c8f1147925023f163c3d45b6f796))
* not one cached logic ([e37157b](https://github.com/omarzum/shihab/commit/e37157b97f22843433e20d0d341a79655e1838b7))
* Nyaa scraper ([950db79](https://github.com/omarzum/shihab/commit/950db795699c831e0e849d6d29e6d6cf5b0ae3a4))
* Nyaa scraper ([a96986c](https://github.com/omarzum/shihab/commit/a96986cec7a2266bf07685e1a09a63b0646bfff4))
* offcloud support ([a318450](https://github.com/omarzum/shihab/commit/a3184507dfe665571502ee5c00c3d6517bfa9b0e))
* oupsie ([2678e9c](https://github.com/omarzum/shihab/commit/2678e9c8046af38ef7b1bdae9457906636fd0c14))
* postgre fix ([acb4d52](https://github.com/omarzum/shihab/commit/acb4d52e782befbc94003461f247079dd86a99d0))
* postgre support ([a98459e](https://github.com/omarzum/shihab/commit/a98459eb42e76212c5a9bfcd9f1e78befc385dbb))
* prowlarr/jackett support ([490f0fa](https://github.com/omarzum/shihab/commit/490f0fa0783eb8a53ab0c915d70823d7a9d2e7c2))
* qol ([5132210](https://github.com/omarzum/shihab/commit/51322104501bcb25daf51d3d82a37f4aaa7ebcd7))
* remove languages and resolutions ([458591f](https://github.com/omarzum/shihab/commit/458591f59310db96198cbe52a3a219d2dd8af353))
* remove normalize_title from metadata handling ([35d2171](https://github.com/omarzum/shihab/commit/35d217168da40f3de20e2ea03c9d29d2c1512ace))
* remove samples ([161351f](https://github.com/omarzum/shihab/commit/161351fce0ffbf4681012034c4eadcd349f78a2b))
* remove_unknown_languages in webui ([96c2fd3](https://github.com/omarzum/shihab/commit/96c2fd339809e7b39ad4cd5cbf9df5e644154ae0))
* revert random manifest id ([f792529](https://github.com/omarzum/shihab/commit/f7925298993e904a635041248079cf578d602818))
* set download torrent files to false by default ([ddac1d0](https://github.com/omarzum/shihab/commit/ddac1d0e0a14629dcc8eb3e9788f6a4a2b5b395b))
* stremthru ([1b5758b](https://github.com/omarzum/shihab/commit/1b5758b610b9c82a3a28b3e23d4181addb8bc084))
* stremthru improvements ([4ac90aa](https://github.com/omarzum/shihab/commit/4ac90aa23b93e73ca3776cce9f0e0551b33409d2))
* switch admin session management from RAM to DB ([abf80fd](https://github.com/omarzum/shihab/commit/abf80fd260d95b079ab053793d32f67641887b91))
* torbox scraper ([95c457b](https://github.com/omarzum/shihab/commit/95c457b6ca0fdea074272df57b3d096b262f14b2))
* torbox scraper ([29fe925](https://github.com/omarzum/shihab/commit/29fe9258d0e41a2391728a3fa4b975a40b97778a))
* update comet scraper stream endpoint path ([0f3a96f](https://github.com/omarzum/shihab/commit/0f3a96f5fdee2cbecdd48b3090504ea5b52a13f3))
* update image URLs from Imgur to ImgBB ([9f3649f](https://github.com/omarzum/shihab/commit/9f3649fe9eb191fd35b03264421163204ca044b6))
* update image URLs from Imgur to ImgBB ([01db8a8](https://github.com/omarzum/shihab/commit/01db8a8ceb941b03dffd1c355e1461bcf151d142))
* update readme ([c151bb4](https://github.com/omarzum/shihab/commit/c151bb446d826e84f3c3313084de4cee0ffafd50))
* webui config ([31144be](https://github.com/omarzum/shihab/commit/31144bef6ddbed102c670abcc16413aa79911c36))


### Bug Fixes

* aaa ([4c933b8](https://github.com/omarzum/shihab/commit/4c933b89e7d3ce576535533159f9c6f3753e1614))
* Add check for missing infoHash in AIOStreams torrent data to prevent errors ([7b9975d](https://github.com/omarzum/shihab/commit/7b9975d4376e643905d0b983543c5c85b90b69bb))
* Add single announce URL to announce list ([789dcff](https://github.com/omarzum/shihab/commit/789dcff4c4f93774d8784321dcd6b1703112a6d6))
* add URL encoding and decoding for stream and torrent names ([b17d727](https://github.com/omarzum/shihab/commit/b17d72789fc621275dbf344bb132fba7232e4b62))
* Adjust total_bytes column type in bandwidth_stats table based on database type ([a8c7ca5](https://github.com/omarzum/shihab/commit/a8c7ca5a29f7c22ea499541ded6bbc9f04d3402a))
* aiostreams scraper ([9cefe9b](https://github.com/omarzum/shihab/commit/9cefe9bf4919b14bde04c1a1732b39548a9e12a8))
* aiostreams scraper ([2962686](https://github.com/omarzum/shihab/commit/29626864a2786e80a3b4b28a5a501a712baeb656))
* back to uvicorn workers ([2d96b46](https://github.com/omarzum/shihab/commit/2d96b463ab0b512eecbd06c3477b5dab80855f35))
* better like this ([37700ac](https://github.com/omarzum/shihab/commit/37700ac3c4d1ce2545e3c0cb862e1db7e14652f3))
* change STREMTHRU_DEFAULT_URL ([1ed3567](https://github.com/omarzum/shihab/commit/1ed35676cd4fdefd5c0d902bcb9ca1deaa64daa2))
* comet scraper title parsing ([b51258a](https://github.com/omarzum/shihab/commit/b51258aeaab80e45f28416bdb4110898a2ebe50e))
* correct addon version ([176899d](https://github.com/omarzum/shihab/commit/176899d4b5e618013e9d15f00c03547d28f6df2c))
* correct PostgreSQL data volume mount path in docker-compose.yml ([7ae3788](https://github.com/omarzum/shihab/commit/7ae3788a5cc81764297588b83dadb939aef6cac1))
* **debrid/stremthru:** handle missing file index ([32ae49e](https://github.com/omarzum/shihab/commit/32ae49ed1dd7ef0ab52ec8f6247250b3a8e888c7))
* default config + prevent old configs ([8d118c9](https://github.com/omarzum/shihab/commit/8d118c90a4a3f9269d6d709d449cacd0dc57892d))
* dependencies ([38deff7](https://github.com/omarzum/shihab/commit/38deff7172d932801494f3306b129e9c5b5c8f68))
* direct torrent results ([dea8a90](https://github.com/omarzum/shihab/commit/dea8a9041cb54245e2fdadd9d914c0285efebc56))
* docker compose ([9d5f21f](https://github.com/omarzum/shihab/commit/9d5f21f6085d0da77ff7d937ed9317a768499486))
* dockerfile ([f5bdca1](https://github.com/omarzum/shihab/commit/f5bdca136a25ba1650b6a2f99b24bdd28c38c64a))
* double quote is better ([b9845dc](https://github.com/omarzum/shihab/commit/b9845dc50d86d33ed690b23b401a6f0efbc8abb2))
* double requests for comet, torrentio and mediafusion ([5e95efc](https://github.com/omarzum/shihab/commit/5e95efc2ca0c99ec09bb6d1b0ac280e64d9387ac))
* duplicated title aliases ([2038919](https://github.com/omarzum/shihab/commit/20389193b1acca625c186f94855ac28649df8b42))
* enhance logging in background scraper and handle unknown seeders in debridio scraper ([43805b3](https://github.com/omarzum/shihab/commit/43805b32813e7b90f9c7cd326c601b092ec9a196))
* ensure PostgreSQL compatibility in admin API metrics ([38196c2](https://github.com/omarzum/shihab/commit/38196c21a0c94b56da0408179b5fed715e38243a))
* explicitely block tmdb requests ([7c7aaa7](https://github.com/omarzum/shihab/commit/7c7aaa71852789233e72f5d3ad759e19f92a314a))
* faster like this ([3f4b944](https://github.com/omarzum/shihab/commit/3f4b944a88693637dfd79c43717d3f25c5c8d80b))
* gevent monkey patch ([1f9c260](https://github.com/omarzum/shihab/commit/1f9c2609144642de96cb54684c8f07d6b28ea328))
* gunicorn worker count ([2d1b2b9](https://github.com/omarzum/shihab/commit/2d1b2b91bf23b876ed37b18f97e063ae165087d9))
* handle commas in size string for size_to_bytes function ([17f2796](https://github.com/omarzum/shihab/commit/17f27966f884b6910d9d3a0366ee9ae6c1359385))
* handle missing results count in YGGTorrent scraper ([52c7718](https://github.com/omarzum/shihab/commit/52c7718c0eaf6eeee2264022b268075257eb36f2))
* info_hash parsing ([a521a04](https://github.com/omarzum/shihab/commit/a521a04a4629c673e5c1f880b2545f33a155549b))
* initialize size to 0 in debridio scraper ([b592a09](https://github.com/omarzum/shihab/commit/b592a093b47cdf98870ece97755fd2c369561fbc))
* kitsu media_id invalid type ([d84744b](https://github.com/omarzum/shihab/commit/d84744be79fdecedb308163076969bf72d67bb69))
* kitsu movies ([58517d5](https://github.com/omarzum/shihab/commit/58517d509c3cd64ce5d693737470c6d6a63772b5))
* kitsu with postgres ([cf69538](https://github.com/omarzum/shihab/commit/cf69538b7df1d0807c8838cd57f8d0771434b4f7))
* last try with gevent ([0b71505](https://github.com/omarzum/shihab/commit/0b7150502bb2fff5d08eaa881e932d9b61930077))
* mb ([fba81f4](https://github.com/omarzum/shihab/commit/fba81f457c38913d4909e24aa6fc1fc8dc317ea7))
* mediaflow ([d6aa837](https://github.com/omarzum/shihab/commit/d6aa837de7d24a57454231ffff5c75ce9a6af788))
* mediafusion ([5b17dc6](https://github.com/omarzum/shihab/commit/5b17dc6be41abe50abd94cc832c31c0a3771c97d))
* more info in env-sample ([bb85887](https://github.com/omarzum/shihab/commit/bb85887df64291a895a8425ab26765271cb39cb2))
* only get file index and size from torrent_file_indexes if in direct torrent mode ([c98c3d4](https://github.com/omarzum/shihab/commit/c98c3d450e10a49885cf028aadb3668a55cb7c1f))
* oupsie ([2c3b08f](https://github.com/omarzum/shihab/commit/2c3b08f857e06748df06834da08e4db135165e66))
* oupsie ([7db04de](https://github.com/omarzum/shihab/commit/7db04de843b5b4f8568e8c12f1066c64b573bd49))
* parse media_id for kitsu movies correctly ([f97a436](https://github.com/omarzum/shihab/commit/f97a436f0b237d437fd405fdcc9140d7142653d4))
* pikpak typo ([33c7fbd](https://github.com/omarzum/shihab/commit/33c7fbd8a25ecca6fa2042551ca231c700aa3ad0))
* pin rank-torrent-name to last working version ([2d4ea89](https://github.com/omarzum/shihab/commit/2d4ea89f6757c768b8b8038bd9ffc45aea314bf2))
* pin rank-torrent-name to last working version ([ec06722](https://github.com/omarzum/shihab/commit/ec06722fb3e841362903f2ba23ef823b887195b4))
* playback proxy with postgre ([8620bce](https://github.com/omarzum/shihab/commit/8620bce8b4740f52e0a01821c01d04cbdce36922))
* postgre stupid ([5c4fa67](https://github.com/omarzum/shihab/commit/5c4fa67bedb0d854b0997ae98f0f13710d65f96a))
* postgre support ([0ee60f7](https://github.com/omarzum/shihab/commit/0ee60f75e0fff99588ab68e83c9254430db9cb14))
* postgres transaction ([936e1a2](https://github.com/omarzum/shihab/commit/936e1a2c597c35878957d6238581972e00c02b3b))
* postgres wrong type ([a90fee8](https://github.com/omarzum/shihab/commit/a90fee8dbfc079a24ceaf666f751af86f07580e3))
* private trackers debrid download (now need stremthru to fix it) ([506ee5b](https://github.com/omarzum/shihab/commit/506ee5bff22d7cea9e1856ee33d6f9259daab1b6))
* probably not it yet ([a3c4176](https://github.com/omarzum/shihab/commit/a3c4176cd2851afaf49c92c4ee9d7344968d34ff))
* remove double-nested append ([4763307](https://github.com/omarzum/shihab/commit/47633073f0aec345a3fad7b63a11bb2b9d9c98cf))
* remove timeout parameter from anime mapping request ([c37e959](https://github.com/omarzum/shihab/commit/c37e959bfd81910b3ee26f13123d7f6e11773cf5))
* remove torrent as a debrid service ([225a2fa](https://github.com/omarzum/shihab/commit/225a2fae5fd36919330f32ffe1475f72422935eb))
* remove unnecessary assignment in debridio scraper ([031582d](https://github.com/omarzum/shihab/commit/031582d546533c871bfa4a0e7a3f21653c7315a8))
* remove unused langage ([9516b1f](https://github.com/omarzum/shihab/commit/9516b1fd05cc38c278cd244ef711d716c84eaacb))
* Rename scrape_attempts to scrape_failed_attempts in BackgroundScraperWorker and database schema for clarity ([cf19560](https://github.com/omarzum/shihab/commit/cf1956011afc21bcd22da5c9230b77612cf901eb))
* revert unwanted change in docker-compose.yml ([03e385d](https://github.com/omarzum/shihab/commit/03e385d1350b081e9b6b108dbe6abca374414d47))
* revert unwanted change in docker-compose.yml ([3e1a7a6](https://github.com/omarzum/shihab/commit/3e1a7a62c15dfb495d2b16c6fc2744042841f76d))
* rtn default settings ([5347499](https://github.com/omarzum/shihab/commit/5347499d21bade1e38446a9918f8e2b72ebd99e8))
* rtn ranking model ([831a0cf](https://github.com/omarzum/shihab/commit/831a0cfeabac55b77f91a0d242ea198d95dba917))
* stremthru ([5264244](https://github.com/omarzum/shihab/commit/52642449288444ae649e1409aa33ed593c45b0a2))
* stremthru token build ([81a9c6d](https://github.com/omarzum/shihab/commit/81a9c6dbd9df5a98dfd9fec76e6da5585978d352))
* Strip 'imdb_id:' prefix from media ID in stream endpoint ([cc5b6a8](https://github.com/omarzum/shihab/commit/cc5b6a8c95d88b5769cce0e2b27d2aa586bfcc07))
* stupid ([5148997](https://github.com/omarzum/shihab/commit/51489971e6eb009114db3aa91b251013a422d9fe))
* support kitsu special episodes without episode number ([ed2fcf4](https://github.com/omarzum/shihab/commit/ed2fcf424810b0d461a905b0b79a6bf6181e4520))
* support kitsu special episodes without episode number ([40fcf8e](https://github.com/omarzum/shihab/commit/40fcf8e410c0abbee1814301b97822e0b5c3e75d))
* torbox cache check ([5dd67f4](https://github.com/omarzum/shihab/commit/5dd67f40089e5f60595c6a38035fc6bb33da76ae))
* torrent queue ([37b12af](https://github.com/omarzum/shihab/commit/37b12af956b9eb709a3b785c6ee1e81edcf3b16d))
* Update AIOSTREAMS_URL type to be optional in AppSettings ([e150015](https://github.com/omarzum/shihab/commit/e150015f24d3ee398d2050eb245f0e73290368b1))
* Update background scraper interval validation to enforce a minimum of 5 minutes ([f01f124](https://github.com/omarzum/shihab/commit/f01f1245cb46801bc9965ee3a12d101ee2a8b728))
* update gitignore ([2d9ffcc](https://github.com/omarzum/shihab/commit/2d9ffcc6db85d49ec3e40477675ebedaa9dd4f60))
* Update log_scraper_error to include URL in error messages for better debugging ([321fd62](https://github.com/omarzum/shihab/commit/321fd624befb117c1e7288a5895134c9c9d27dfb))
* update manifest name to exclude 'TORRENT' from debrid extension ([d916fe0](https://github.com/omarzum/shihab/commit/d916fe03e0ec986ceb2960085f2776f4d809dbcf))
* update mediafusion config ([73f5fc4](https://github.com/omarzum/shihab/commit/73f5fc40093460ef41dbb244fd1bf6a40d365ef2))
* update models to be compatible with latest RTN ([7fb18b2](https://github.com/omarzum/shihab/commit/7fb18b2383f3c24c40525b70544fd6ab8fc7803c))
* update models to be compatible with latest RTN ([3967c42](https://github.com/omarzum/shihab/commit/3967c42bd095a7a297389adafc86025bb5e413bb))
* update playback route to accept path parameters ([7658949](https://github.com/omarzum/shihab/commit/76589492dc18d2cc9846643e0fe52d5281e687c2))
* update RTN dep to 1.8.2 ([a9350ea](https://github.com/omarzum/shihab/commit/a9350ea8aa3e82bbd2b40efaba494915d55c99ae))
* update RTN dep to 1.8.2 ([11ca645](https://github.com/omarzum/shihab/commit/11ca6459e9c2f9b53fed834629b31f36eb5d9764))
* update RTN dep to 1.8.3 ([3b1759c](https://github.com/omarzum/shihab/commit/3b1759cac969e2df222619de93d3149bdc9bb81e))
* update RTN dep to 1.8.3 ([7c995e5](https://github.com/omarzum/shihab/commit/7c995e535ed882fd7cdd9b33bfd3abff00ecd6d9))
* update sample ([3de418f](https://github.com/omarzum/shihab/commit/3de418f19ff1be77d898e2800877d6b83b0cb8b1))
* update title matching logic in StremThru and TorrentManager ([657748c](https://github.com/omarzum/shihab/commit/657748c1e1973b1000ccbad8383760f84a6bed74))
* Update YGG domain URL ([a9b223f](https://github.com/omarzum/shihab/commit/a9b223f1cd713744693d576c830e9618471b39d0))
* use get method for safer access to seeders, tracker, and sources maps ([43e92a2](https://github.com/omarzum/shihab/commit/43e92a2990dd3002a629e61b02d035b5910a315b))
* use torrent name as media_id instead of torrent hash ([740140e](https://github.com/omarzum/shihab/commit/740140eb2748fa1ccde70c1fea39f6add5d03c6f))
* wrong rtn setting model ([2240aed](https://github.com/omarzum/shihab/commit/2240aed22abadcce5f36a97af79a2bf6471017fa))
* wrong season/episode ([683b348](https://github.com/omarzum/shihab/commit/683b348d127dd26be618f6d332334b3f2d3be31f))
* wut ([c020f2c](https://github.com/omarzum/shihab/commit/c020f2cd8d9909b67f0b424d7787e584480ac43e))


### Code Refactoring

* 2025 rewrite complete ([e62e7c4](https://github.com/omarzum/shihab/commit/e62e7c4b1eed37e7950b3effaf6b38ddd47e9c6a))
